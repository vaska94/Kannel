...
[![Version](https://img.shields.io/badge/version-1.8.11-blue.svg)](https://github.com/vaska94/Kamex/releases)
...
- **IPv6** - Opt-in dual-stack listeners and outbound resolution (`ipv6 = true`)
